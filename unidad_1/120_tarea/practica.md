...
- [Librerias](#librerias)
- [Letura de datos](#letura-de-datos)
...
``` r
data_path <- file.path("C:/Users/KoMeTa/OneDrive - Universidad Privada del Valle/CODES/EST4/unidad_1/120_tarea/archive"  )
...
![](practica_files/figure-gfm/unnamed-chunk-16-1.png)<!-- --> \##
...
```
    ...
    ## Estadísticas básicas de la Muestra 1 para Peso_NA:
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##  0.0000  0.0000  0.5000  0.4578  0.7500  1.0000
...
![](practica_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##  0.0000  0.0000  0.5000  0.4521  0.7500  1.0000
...
![](practica_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](practica_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
```
    ...
    ## 
    ##  # * Representatividad de las muestras: Las estadísticas descriptivas (media, mediana, cuartiles) de ambas muestras son muy similares a las de la población total de interés. 
    ##  #   Por ejemplo, la media de la población es de aproximadamente 0.45, mientras que en las muestras es de 0.46 y 0.45. 
    ##  #   Esto indica que el muestreo aleatorio simple ha sido efectivo y las muestras son representativas.
    ## 
    ##  # * Forma de la distribución: El gráfico comparativo de densidades muestra que las curvas de ambas muestras siguen de cerca la forma de la distribución de la población. 
    ##  #   Esto confirma visualmente que las muestras han capturado las características principales de la población.
